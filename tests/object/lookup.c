...
void test_object_lookup__lookup_wrong_type_returns_enotfound(void)
{
	...
	cl_git_pass(git_oid_fromstr(&oid, commit, GIT_HASH_ALGO_SHA1));
	cl_assert_equal_i(
...
void test_object_lookup__lookup_nonexisting_returns_enotfound(void)
{
	...
	cl_git_pass(git_oid_fromstr(&oid, unknown, GIT_HASH_ALGO_SHA1));
	cl_assert_equal_i(
...
void test_object_lookup__lookup_wrong_type_by_abbreviated_id_returns_enotfound(void)
{
	...
	cl_git_pass(git_oid_fromstrn(&oid, commit, strlen(commit), GIT_HASH_ALGO_SHA1));
	cl_assert_equal_i(
