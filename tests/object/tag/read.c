...
void test_object_tag_read__parse(void)
{
	...
	git_oid_fromstr(&id1, tag1_id, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id2, tag2_id, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id_commit, tagged_commit, GIT_HASH_ALGO_SHA1);
...
void test_object_tag_read__parse_without_tagger(void)
{
	...
	git_oid_fromstr(&id, bad_tag_id, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id_commit, badly_tagged_commit, GIT_HASH_ALGO_SHA1);
...
void test_object_tag_read__parse_without_message(void)
{
	...
	git_oid_fromstr(&id, short_tag_id, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id_commit, short_tagged_commit, GIT_HASH_ALGO_SHA1);
...
void test_object_tag_read__without_tagger_nor_message(void)
{
	...
	cl_git_pass(git_oid_fromstr(&id, taggerless, GIT_HASH_ALGO_SHA1));
