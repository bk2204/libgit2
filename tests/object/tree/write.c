...
void test_object_tree_write__from_memory(void)
{
	...
	git_oid_fromstr(&id, first_tree, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id2, second_tree, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&bid, blob_oid, GIT_HASH_ALGO_SHA1);
...
void test_object_tree_write__subtree(void)
{
	...
	git_oid_fromstr(&id, first_tree, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id2, second_tree, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&id3, third_tree, GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&bid, blob_oid, GIT_HASH_ALGO_SHA1);
...
void test_object_tree_write__sorted_subtrees(void)
{
	...
	cl_git_pass(git_oid_fromstr(&bid, blob_oid, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&tid, first_tree, GIT_HASH_ALGO_SHA1));
...
void test_object_tree_write__removing_and_re_adding_in_treebuilder(void)
{
	...
	cl_git_pass(git_oid_fromstr(&entry_oid, blob_oid, GIT_HASH_ALGO_SHA1));
...
void test_object_tree_write__filtering(void)
{
	...
	git_oid_fromstr(&entry_oid, blob_oid, GIT_HASH_ALGO_SHA1);
...
void test_object_tree_write__protect_filesystems(void)
{
	...
	cl_git_pass(git_oid_fromstr(&bid, "fa49b077972391ad58037050f2a75f74e3671e92", GIT_HASH_ALGO_SHA1));
...
#define assert_allowed(expr) \
	...
	cl_git_pass(git_oid_fromstr(&valid_blob_id, blob_oid, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&invalid_blob_id,
		"1234567890123456789012345678901234567890", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&valid_tree_id, first_tree, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&invalid_tree_id,
		"0000000000111111111122222222223333333333", GIT_HASH_ALGO_SHA1));
...
static void test_inserting_submodule(void)
{
	...
	cl_git_pass(git_oid_fromstr(&sm_id, "da39a3ee5e6b4b0d3255bfef95601890afd80709", GIT_HASH_ALGO_SHA1));
