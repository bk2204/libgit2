    ...
    size_t treediff_conflict_data_len)
{
	...
	cl_git_pass(git_oid_fromstr(&ancestor_oid, ancestor_oidstr, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&ours_oid, ours_oidstr, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&theirs_oid, theirs_oidstr, GIT_HASH_ALGO_SHA1));
