...
void test_merge_workdir_trivial__13(void)
{
	...
	cl_git_pass(git_oid_fromstr(&expected_oid, "1cff9ec6a47a537380dedfdd17c9e76d74259a2b", GIT_HASH_ALGO_SHA1));
...
void test_merge_workdir_trivial__14(void)
{
	...
	cl_git_pass(git_oid_fromstr(&expected_oid, "26153a3ff3649b6c2bb652d3f06878c6e0a172f9", GIT_HASH_ALGO_SHA1));
	cl_assert(git_oid_cmp(&entry->id, &expected_oid) == 0);
