...
static void populate_fetchhead(git_vector *out, git_repository *repo)
{
	...
	cl_git_pass(git_oid_fromstr(&oid,
		"49322bb17d3acc9146f98c97d078513228bbf3c0", GIT_HASH_ALGO_SHA1));
	...
	cl_git_pass(git_oid_fromstr(&oid,
		"0966a434eb1a025db6b71485ab63a3bfbea520b6", GIT_HASH_ALGO_SHA1));
	...
	cl_git_pass(git_oid_fromstr(&oid,
		"42e4e7c5e507e113ebbb7801b16b52cf867b7ce1", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_fetchhead_ref_create(&fetchhead_ref, &oid, 0,
	...
	cl_git_pass(git_oid_fromstr(&oid,
		"d96c4e80345534eccee5ac7b07fc7603b56124cb", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_fetchhead_ref_create(&fetchhead_ref, &oid, 0,
	...
	cl_git_pass(git_oid_fromstr(&oid,
		"55a1a760df4b86a02094a904dfa511deb5655905", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_fetchhead_ref_create(&fetchhead_ref, &oid, 0,
		"refs/tags/blob",
		"git://github.com/libgit2/TestGitRepository"));
	cl_git_pass(git_vector_insert(out, fetchhead_ref));
	...
	cl_git_pass(git_oid_fromstr(&oid,
		"8f50ba15d49353813cc6e20298002c0d17b0a9ee", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_fetchhead_ref_create(&fetchhead_ref, &oid, 0,
	...
	const git_oid *oid, unsigned int is_merge, void *payload)
{
	...
	git_oid_fromstr(&expected, "49322bb17d3acc9146f98c97d078513228bbf3c0", GIT_HASH_ALGO_SHA1);
...
void test_fetchhead_nonetwork__credentials_are_stripped(void)
{
	...
	cl_git_pass(git_oid_fromstr(&oid, "49322bb17d3acc9146f98c97d078513228bbf3c0", GIT_HASH_ALGO_SHA1));
