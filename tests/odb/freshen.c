...
void test_odb_freshen__loose_blob(void)
{
	...
	cl_git_pass(git_oid_fromstr(&expected_id, LOOSE_BLOB_ID, GIT_HASH_ALGO_SHA1));
...
void test_odb_freshen__readonly_object(void)
{
	...
	cl_git_pass(git_oid_fromstr(&expected_id, UNIQUE_BLOB_ID, GIT_HASH_ALGO_SHA1));
...
void test_odb_freshen__loose_tree(void)
{
	...
	cl_git_pass(git_oid_fromstr(&expected_id, LOOSE_TREE_ID, GIT_HASH_ALGO_SHA1));
...
void test_odb_freshen__tree_during_commit(void)
{
	...
	cl_git_pass(git_oid_fromstr(&tree_id, LOOSE_TREE_ID, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_tree_lookup(&tree, repo, &tree_id));
	set_time_wayback(&before, LOOSE_TREE_FN);

	cl_git_pass(git_oid_fromstr(&parent_id, "a65fedf39aefe402d3bb6e24df4d4f5fe4547750", GIT_HASH_ALGO_SHA1));
...
void test_odb_freshen__packed_object(void)
{
	...
	cl_git_pass(git_oid_fromstr(&expected_id, PACKED_ID, GIT_HASH_ALGO_SHA1));
