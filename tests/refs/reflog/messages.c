...
void test_refs_reflog_messages__detaching_writes_reflog(void)
{
	...
	git_oid_fromstr(&id, "e90810b8df3e80c413d903f631643c716887138d", GIT_HASH_ALGO_SHA1);
...
void test_refs_reflog_messages__newline_gets_replaced(void)
{
	...
	cl_git_pass(git_oid_fromstr(&oid, "a65fedf39aefe402d3bb6e24df4d4f5fe4547750", GIT_HASH_ALGO_SHA1));
