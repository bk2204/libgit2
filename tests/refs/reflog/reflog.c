...
void test_refs_reflog_reflog__append_then_read(void)
{
	...
	git_oid_fromstr(&oid, current_master_tip, GIT_HASH_ALGO_SHA1);
...
void test_refs_reflog_reflog__removes_empty_reflog_dir(void)
{
	...
	/* Create a new branch pointing at the HEAD */
	git_oid_fromstr(&id, current_master_tip, GIT_HASH_ALGO_SHA1);
...
void test_refs_reflog_reflog__reading_a_reflog_with_invalid_format_succeeds(void)
{
	...
	/* Create a new branch. */
	cl_git_pass(git_oid_fromstr(&id, current_master_tip, GIT_HASH_ALGO_SHA1));
...
void test_refs_reflog_reflog__append_to_HEAD_when_changing_current_branch(void)
{
	...
	/* Move it back */
	git_oid_fromstr(&id, "be3563ae3f795b2b4353bcce3a527ad0a4f7f644", GIT_HASH_ALGO_SHA1);
