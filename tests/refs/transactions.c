...
void test_refs_transactions__single_ref_oid(void)
{
	...
	git_oid_fromstr(&id, "a65fedf39aefe402d3bb6e24df4d4f5fe4547750", GIT_HASH_ALGO_SHA1);
...
void test_refs_transactions__error_on_locking_locked_ref(void)
{
	...
	cl_git_pass(git_oid_fromstr(&id, "a65fedf39aefe402d3bb6e24df4d4f5fe4547750", GIT_HASH_ALGO_SHA1));
