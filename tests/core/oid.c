...
{
	cl_git_pass(git_oid_fromstr(&id, str_oid, GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstrp(&idp, str_oid_p, GIT_HASH_ALGO_SHA1));
	cl_git_fail(git_oid_fromstrp(&idm, str_oid_m, GIT_HASH_ALGO_SHA1));
}
