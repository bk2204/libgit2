...
void test_checkout_tree__doesnt_write_unrequested_files_to_worktree(void)
{
	...
	git_oid_fromstr(&master_oid, "a65fedf39aefe402d3bb6e24df4d4f5fe4547750", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&chomped_oid, "e90810b8df3e80c413d903f631643c716887138d", GIT_HASH_ALGO_SHA1);
...
void test_checkout_tree__donot_update_deleted_file_by_default(void)
{
	...
	cl_git_pass(git_oid_fromstr(&old_id, "be3563ae3f795b2b4353bcce3a527ad0a4f7f644", GIT_HASH_ALGO_SHA1));
	...
	cl_git_pass(git_oid_fromstr(&new_id, "099fabac3a9ea935598528c27f866e34089c2eff", GIT_HASH_ALGO_SHA1));
...
static void create_conflict(const char *path)
{
	...
	git_oid_fromstr(&entry.id, "d427e0b2e138501a3d15cc376077a3631e15bd46", GIT_HASH_ALGO_SHA1);
	entry.path = path;
	cl_git_pass(git_index_add(index, &entry));

	GIT_INDEX_ENTRY_STAGE_SET(&entry, 2);
	git_oid_fromstr(&entry.id, "ee3fa1b8c00aff7fe02065fdb50864bb0d932ccf", GIT_HASH_ALGO_SHA1);
	cl_git_pass(git_index_add(index, &entry));

	GIT_INDEX_ENTRY_STAGE_SET(&entry, 3);
	git_oid_fromstr(&entry.id, "2bd0a343aeef7a2cf0d158478966a6e587ff3863", GIT_HASH_ALGO_SHA1);
	cl_git_pass(git_index_add(index, &entry));
...
void test_checkout_tree__filemode_preserved_in_index(void)
{
	...
	cl_git_pass(git_oid_fromstr(&executable_oid, "afe4393b2b2a965f06acf2ca9658eaa01e0cd6b6", GIT_HASH_ALGO_SHA1));
	...
	cl_git_pass(git_oid_fromstr(&executable_oid, "cf80f8de9f1185bf3a05f993f6121880dd0cfbc9", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_commit_lookup(&commit, g_repo, &executable_oid));
	...
	cl_git_pass(git_oid_fromstr(&executable_oid, "144344043ba4d4a405da03de3844aa829ae8be0e", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_commit_lookup(&commit, g_repo, &executable_oid));
...
void test_checkout_tree__removes_conflicts(void)
{
	...
	cl_git_pass(git_oid_fromstr(&commit_id, "afe4393b2b2a965f06acf2ca9658eaa01e0cd6b6", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_commit_lookup(&commit, g_repo, &commit_id));
...
static void modify_index_ondisk(void)
{
	...
	cl_git_pass(git_oid_fromstr(&entry.id, "1385f264afb75a56a5bec74243be9b367ba4ca08", GIT_HASH_ALGO_SHA1));
	entry.mode = 0100644;
	entry.path = "README";
