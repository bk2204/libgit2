...
static void unmerged_index_init(git_index *index, int entries)
{
	...
	git_oid_fromstr(&ancestor, "452e4244b5d083ddf0460acf1ecc74db9dcfa11a", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&ours, "32504b727382542f9f089e24fddac5e78533e96c", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&theirs, "061d42a44cacde5726057b67558821d95db96f19", GIT_HASH_ALGO_SHA1);
