...
void test_diff_workdir__to_index_with_conflicts(void)
{
	...
	git_oid_fromstr(&our_entry.id, "ee3fa1b8c00aff7fe02065fdb50864bb0d932ccf", GIT_HASH_ALGO_SHA1);

	their_entry.path = "subdir/rename_conflict";
	their_entry.mode = 0100644;
	git_oid_fromstr(&their_entry.id, "2bd0a343aeef7a2cf0d158478966a6e587ff3863", GIT_HASH_ALGO_SHA1);
...
void test_diff_workdir__to_index_conflicted(void) {
	...
	git_oid_fromstr(&ancestor.id, "d427e0b2e138501a3d15cc376077a3631e15bd46", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&ours.id, "ee3fa1b8c00aff7fe02065fdb50864bb0d932ccf", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&theirs.id, "2bd0a343aeef7a2cf0d158478966a6e587ff3863", GIT_HASH_ALGO_SHA1);
