...
void test_diff_format_email__multiple(void)
{
	...
	git_oid_fromstr(&oid, "10808fe9c9be5a190c0ba68d1a002233fb363508", GIT_HASH_ALGO_SHA1);
	cl_git_pass(git_commit_lookup(&commit, repo, &oid));
	...
	git_oid_fromstr(&oid, "873806f6f27e631eb0b23e4b56bea2bfac14a373", GIT_HASH_ALGO_SHA1);
	cl_git_pass(git_commit_lookup(&commit, repo, &oid));
...
void test_diff_format_email__invalid_no(void)
{
	...
	git_oid_fromstr(&oid, "9264b96c6d104d0e07ae33d3007b6a48246c6f92", GIT_HASH_ALGO_SHA1);
