...
committer Rebaser <rebaser@rebaser.rb> 1405694510 +0000\n";
	...
	git_oid_fromstr(&expected_id, "129183968a65abd6c52da35bff43325001bfc630", GIT_HASH_ALGO_SHA1);
...
gpgsig -----BEGIN PGP SIGNATURE-----\n\
 ...
 -----END PGP SIGNATURE-----\n";
	...
	git_oid_fromstr(&expected_id, "bf78348e45c8286f52b760f1db15cb6da030f2ef", GIT_HASH_ALGO_SHA1);
	cl_assert_equal_oid(&expected_id, &commit_id);
...
magicsig magic word: pretty please\n";
	...
	git_oid_fromstr(&expected_id, "f46a4a8d26ae411b02aa61b7d69576627f4a1e1c", GIT_HASH_ALGO_SHA1);
	cl_assert_equal_oid(&expected_id, &commit_id);
