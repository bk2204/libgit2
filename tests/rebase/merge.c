...
void test_rebase_merge__next(void)
{
	...
	git_oid_fromstr(&master_id, "efad0b11c47cb2f0220cbd6f5b0f93bb99064b00", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&beef_id, "b146bd7608eac53d9bf9e1a6963543588b555c64", GIT_HASH_ALGO_SHA1);
	...
	git_oid_fromstr(&pick_id, "da9c51a23d02d931a486f45ad18cda05cf5d2b94", GIT_HASH_ALGO_SHA1);
	...
	git_oid_fromstr(&file1_id, "8d95ea62e621f1d38d230d9e7d206e41096d76af", GIT_HASH_ALGO_SHA1);
...
"sufficiently done, thicken with flour, butter and milk, and serve it up.\n";
	...
	git_oid_fromstr(&pick_id, "33f915f9e4dbd9f4b24430e48731a59b45b15500", GIT_HASH_ALGO_SHA1);
...
void test_rebase_merge__commit(void)
{
	...
	git_oid_fromstr(&parent_id, "efad0b11c47cb2f0220cbd6f5b0f93bb99064b00", GIT_HASH_ALGO_SHA1);
	cl_assert_equal_i(1, git_commit_parentcount(commit));
	cl_assert_equal_oid(&parent_id, git_commit_parent_id(commit, 0));

	git_oid_fromstr(&tree_id, "4461379789c777d2a6c1f2ee0e9d6c86731b9992", GIT_HASH_ALGO_SHA1);
...
void test_rebase_merge__commit_with_id(void)
{
	...
	cl_git_pass(git_oid_fromstr(&branch_id, "b146bd7608eac53d9bf9e1a6963543588b555c64", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&upstream_id, "efad0b11c47cb2f0220cbd6f5b0f93bb99064b00", GIT_HASH_ALGO_SHA1));
...
void test_rebase_merge__finish_with_ids(void)
{
	...
	cl_git_pass(git_oid_fromstr(&branch_id, "d616d97082eb7bb2dc6f180a7cca940993b7a56f", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_oid_fromstr(&upstream_id, "f87d14a4a236582a0278a916340a793714256864", GIT_HASH_ALGO_SHA1));
...
void test_rebase_merge__no_common_ancestor(void)
{
	...
	git_oid_fromstr(&expected_final_id, "71e7ee8d4fe7d8bf0d107355197e0a953dfdb7f3", GIT_HASH_ALGO_SHA1);
...
void test_rebase_merge__with_directories(void)
{
	...
	git_oid_fromstr(&tree_id, "a4d6d9c3d57308fd8e320cf2525bae8f1adafa57", GIT_HASH_ALGO_SHA1);
