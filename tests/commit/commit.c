...
void test_commit_commit__create_unexisting_update_ref(void)
{
	...
	git_oid_fromstr(&oid, "a65fedf39aefe402d3bb6e24df4d4f5fe4547750", GIT_HASH_ALGO_SHA1);
	cl_git_pass(git_commit_lookup(&commit, _repo, &oid));

	git_oid_fromstr(&oid, "944c0f6e4dfa41595e6eb3ceecdb14f50fe18162", GIT_HASH_ALGO_SHA1);
