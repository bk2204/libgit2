...
void test_apply_workdir__generated_diff(void)
{
	...
	git_oid_fromstr(&b_oid, "7c7bf85e978f1d18c0566f702d2cb7766b9c8d4f", GIT_HASH_ALGO_SHA1); cl_git_pass(git_commit_lookup(&a_commit, repo, &a_oid));
...
void test_apply_workdir__modified_index_with_unmodified_workdir_is_ok(void)
{
	...
	cl_git_pass(git_oid_fromstr(&idx_entry.id, "ffb36e513f5fdf8a6ba850a20142676a2ac4807d", GIT_HASH_ALGO_SHA1));
