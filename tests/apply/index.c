...
void test_apply_index__initialize(void)
{
	...
	git_oid_fromstr(&oid, "539bd011c4822c560c1d17cab095006b7a10f707", GIT_HASH_ALGO_SHA1);
...
void test_apply_index__generate_diff(void)
{
	...
	git_oid_fromstr(&a_oid, "539bd011c4822c560c1d17cab095006b7a10f707", GIT_HASH_ALGO_SHA1);
	git_oid_fromstr(&b_oid, "7c7bf85e978f1d18c0566f702d2cb7766b9c8d4f", GIT_HASH_ALGO_SHA1);
...
void test_apply_index__keeps_nonconflicting_changes(void)
{
	...
	cl_git_pass(git_oid_fromstr(&idx_entry.id, "898d12687fb35be271c27c795a6b32c8b51da79e", GIT_HASH_ALGO_SHA1));
...
void test_apply_index__can_apply_nonconflicting_file_changes(void)
{
	...
	cl_git_pass(git_oid_fromstr(&idx_entry.id, "06d3fefb8726ab1099acc76e02dfb85e034b2538", GIT_HASH_ALGO_SHA1));
	cl_git_pass(git_index_add(index, &idx_entry));
